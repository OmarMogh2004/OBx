...
client.on('message', message => {
     ...
     if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply(' **__ليس لديك صلاحيات__**');
              ...
              SEND_MESSAGES: false
                    ...
                    message.reply("**__You Closed The Chat__ :white_check_mark: **")
                });
                  }
     ...
     if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('**__ليس لديك صلاحيات__**');
              ...
              SEND_MESSAGES: true
                    ...
                    message.reply("**__You Opened The Chat__:white_check_mark:**")
                });
      }
...
message.reply("`All the roles deleted successfully`")
}
});
client.on('message', message => {
...
client.login("NTMwMzY5NjQ0MDMzMjEyNDE2.Dw-aMQ.D_S19i5VDrZnAD7lJeopT5ClcfI");  // توكن حقق
